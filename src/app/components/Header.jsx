        ...
        <header className="bg-gray-700 fixed w-full" >
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
                ...
                <section className="flex gap-10">
                    <article class="hidden lg:flex lg:gap-x-12 ">
                        <div class="relative">
                            <button type="button" className=" text-white flex items-center gap-x-1 text-sm font-semibold leading-6" aria-expanded="false">
                            Cursos
                    ...
                    <article class="hidden lg:flex lg:flex-1 lg:justify-end">
                        <Link href="#" class="text-sm font-semibold leading-6 text-white">Log in <span aria-hidden="true">&rarr;</span></Link>
                    </article>
                </section>
            </nav>
            {/* <!-- Mobile menu, show/hide based on menu open state. --> */}
            <section className="lg:hidden" role="dialog" aria-modal="true">
                {/* <!-- Background backdrop, show/hide based on slide-over state. --> */}
                <div className="fixed inset-0 z-10"></div>
                <article className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
